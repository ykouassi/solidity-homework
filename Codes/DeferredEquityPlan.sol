...
contract DeferredEquityPlan {
    ...
    uint public start_time = now; // permanently store the time this contract was initialized
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "contract is still locked");


        // 2: `distributed_shares` is less than the `total_shares`


        require(distributed_shares <= total_shares, "distributed_shares must be less than total shares");
